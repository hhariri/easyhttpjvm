...
import org.easyHttp.JsonDeserializer
...
class DeserializationTests {
    ...
    spec fun valid_json_should_deserialize() {
        ...
        val customer = jsonDeserializer.deserialize("{name: \"Joe\", email: \"joe@smith.com\", address: {street:\"Street\", number: 10, city: \"Lonodon\"}}", javaClass<CustomerClass>())
